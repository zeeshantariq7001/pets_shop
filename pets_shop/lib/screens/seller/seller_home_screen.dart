...
import 'package:pets_shop/screens/seller/pet_foods/seller_add_pet_food.dart';
import 'package:pets_shop/screens/seller/pet_desease/seller-add_medicine_screen.dart';
import 'package:pets_shop/screens/seller/checkout_screen/seller_order_screen.dart';
import 'package:pets_shop/screens/seller/pet_desease/all_desease_screen.dart';
import 'package:pets_shop/screens/seller/pet_foods/seller_view_pet_food.dart';
              ...
              EcoButton(
                ...
                onpress: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => ALLAccessoriesHere()));
                },
              ),
              const Text(
                "MEDICINE",
              ...
              EcoButton(
                ...
                onpress: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => SellerAddPetFood()));
                },
              ),
              EcoButton(
                title: "ALL PETS FOOD",
                onpress: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => SellerViewPetFood()));
                },
              ),
              // const Text(
              //   "ORDERS",
